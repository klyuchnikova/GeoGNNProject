...
BASE_ARGS="--model lstm --seq-len 20 --batch-size 512 --epochs 20 --lr 0.0005 --weight-decay 1e-5 --hidden-dim 256 --num-layers 2 --dropout 0.1 --device cuda --seed 42 --lr-scheduler-factor 0.1 --lr-scheduler-patience 3"
...
for DATASET in foursquare gowalla; do
  echo "=========================================="
  echo "Running LSTM experiments on $DATASET"
  echo "=========================================="
...
echo "=========================================="
echo "All LSTM experiments completed!"
echo "=========================================="
