...
def test_synthetic_prepare(tmp_path):
    ...
    cfg=load_config("configs/smoke.yaml");cfg.data.raw_checkins=str(check);cfg.data.raw_friendships=str(friend);cfg.data.output_dir=str(tmp_path/"out");cfg.data.min_checkins=10;cfg.data.max_users=0
